...
uint256 hashGenesisBlock("0x8e0e420507d8156752554f164fdfb3d7f7f37bdb4dac24a63bf6c5c45d341957");
...
const string strMessageMagic = "jlcoin Signed Message:\n";
...
static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // jlcoin: 1 days
static const int64 nTargetSpacing = 120; // jlcoin: 2 minute blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal jlcoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "jlcoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x8e0e420507d8156752554f164fdfb3d7f7f37bdb4dac24a63bf6c5c45d341957");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Building JLCoin";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1492158457; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2808534;

        if (fTestNet)
        {
            block.nTime    = 1492158457;
            block.nNonce   = 2808534;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x7f8cb1602788f2b8b89b2fdb3c02703188239d5f4fa2e8044c207f897c7dfc6e"));
